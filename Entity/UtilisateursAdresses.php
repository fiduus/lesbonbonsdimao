 ...
 * @ORM\Entity(repositoryClass="fidi\EcommerceBundle\Repository\UtilisateursAdressesRepository")
 * @GRID\Source(columns="nom,prenom,adresse, cp, pays", groupBy={"id"})
 */
class UtilisateursAdresses
{
    ...
    public $id;
    /**
     * @ORM\ManyToOne(targetEntity="fidi\UserBundle\Entity\User", inversedBy="adresses")
