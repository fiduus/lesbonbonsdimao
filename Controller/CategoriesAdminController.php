...
use fidi\EcommerceBundle\Form\CategoriesType;
...
class CategoriesAdminController extends Controller
{
  ...
  /**
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('fidiEcommerceBundle:Categories')->findAll();
        return $this->render('fidiEcommerceBundle:Administration:Categories/layout/index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('fidiEcommerceBundle:Administration:Categories/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('fidiEcommerceBundle:Categories')->find($id);
        if (!$entity) {
            throw $this->createNotFoundException('Entité catégorie non trouvée.');
        }
        $deleteForm = $this->createDeleteForm($id);
        return $this->render('fidiEcommerceBundle:Administration:Categories/layout/show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        $deleteForm = $this->createDeleteForm($id);
        return $this->render('fidiEcommerceBundle:Administration:Categories/layout/edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $editForm->handleRequest($request);
         if ($editForm->isValid()) {
            $em->flush();
            $this->get('session')->getFlashBag()->add('success','Catégorie mise à jour avec succès');
